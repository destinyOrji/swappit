...
class ApiService {
  ...
  Future<Map<String, dynamic>> updateSkills(List<int> offered, List<int> wanted) async {
  ...
  Future<Map<String, dynamic>> rateTrade(int tradeId, double stars, String? comment) async {
  ...
  Future<Map<String, dynamic>> getNotifications() async {
    final res = await http.get(_uri(ApiConstants.notifications), headers: await _headers);
    return _handle(res);
  }
